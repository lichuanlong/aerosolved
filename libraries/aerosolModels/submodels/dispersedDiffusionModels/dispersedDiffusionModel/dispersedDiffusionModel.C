...
defineTypeNameAndDebug(dispersedDiffusionModel, 0);
defineRunTimeSelectionTable(dispersedDiffusionModel, dictionary);

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

dispersedDiffusionModel::dispersedDiffusionModel
(
...
tmp<volScalarField> dispersedDiffusionModel::D(const volScalarField& d) const
{
